    ...
    public void invoke(Object target, Object[] arguments) throws Exception {
        ...
        if (coms.length == 1) {
            ...
            if (coms.length == 2 && arguments.length >= 1) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass());
                method.invoke(target, arguments[0]);
            }
            else if (coms.length == 3 && arguments.length >= 2) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass(), arguments[1].getClass());
                method.invoke(target, arguments[0], arguments[1]);
            }
            else if (coms.length == 4 && arguments.length >= 3) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass(), arguments[1].getClass(), arguments[2].getClass());
                method.invoke(target, arguments[0], arguments[1], arguments[2]);
            }
            else if (coms.length == 5 && arguments.length >= 4) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass(), arguments[1].getClass(), arguments[2].getClass(), arguments[3].getClass());
                method.invoke(target, arguments[0], arguments[1], arguments[2], arguments[3]);
            }
            else if (coms.length == 6 && arguments.length >= 5) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass(), arguments[1].getClass(), arguments[2].getClass(), arguments[3].getClass(), arguments[4].getClass());
                method.invoke(target, arguments[0], arguments[1], arguments[2], arguments[3], arguments[4]);
            }
            else if (coms.length == 7 && arguments.length >= 6) {
                method = clazz.getDeclaredMethod(coms[0], arguments[0].getClass(), arguments[1].getClass(), arguments[2].getClass(), arguments[3].getClass(), arguments[4].getClass(), arguments[5].getClass());
