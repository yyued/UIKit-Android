...
public class UINavigationItem {
    ...
    public void updateTitle() {
        if (getTitleView() != null && getTitleView() instanceof UILabel) {
            if (mNavigationBar != null && mNavigationBar.getTitleTextAttributes() != null) {
                if (mTitle != null) {
                    NSAttributedString attributedString = new NSAttributedString(mTitle, mNavigationBar.getTitleTextAttributes());
                    ((UILabel) getTitleView()).setAttributedText(attributedString);
                }
                else {
                    ((UILabel) getTitleView()).setText("");
                }
            }
            else {
                ((UILabel) getTitleView()).setText(mTitle);
            }
            if (getTitleView().getSuperview() != null) {
                getTitleView().getSuperview().layoutSubviews();
            }
        }
    }
    ...
    public UIBarButtonItem getBackBarButtonItem() {
        ...
        if (mBackBarButtonItem == null && mNavigationBar.isMaterialDesign()) {
            ...
            mBackBarButtonItem.setImageInsets(new UIEdgeInsets(0, 0, 0, 0));
            mBackBarButtonItem.mSystemBackItem = true;
        }
